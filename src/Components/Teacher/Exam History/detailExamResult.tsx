...
const DetailExamResult = () => {
  ...
  const currentStudent = location.state?.student;

  const answers = currentStudent?.answers.split(",");
      ...
      <main className="p-6 bg-gray-50 dark:bg-gray-900 shadow-sm border rounded border-gray-200 dark:border-gray-700 mt-2">
        <div className="flex flex-col md:flex-row p-4 gap-4">
          ...
          <div className="w-full md:w-1/3 p-4 border rounded-lg shadow-sm bg-white">
            ...
            <p>
              <strong>Score:</strong> {currentStudent.score} points
            </p>
            <p>
              <strong>Duration:</strong> {currentStudent.duration} minutes
            </p>
                  ...
                  <button
                    ...
                    className={
                      q.correctAnswer === answers[i]
                        ? "border border-gray-200 px-3 py-1 rounded text-sm bg-white hover:bg-blue-100"
                        : "border border-red-500 px-3 py-1 rounded text-sm bg-white hover:bg-blue-100"
                    }
                  >
                    {i + 1}
                  </button>
